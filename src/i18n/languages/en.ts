export default {
  ...
  download: 'Download',
  version: 'Version',
  linuxDebVersion: 'Linux Deb Version',
  windowsSetupVersion: 'Windows Setup Version',
  downloadDescriptions:
    ' Steak is a modern, cross-platform game distribution platform that allows gamers to quickly, safely, and conveniently download, install, and update games. With a minimalist yet gaming-inspired interface, Steak offers a smooth experience suitable for both AAA and indie games.',
  languages: 'Languages',
  ...
  steakStore: 'Steak Store',
  clientApp: 'Client App',
  tickets: 'Tickets',
  createTickets: 'Create Tickets',
  welcomeToTheHelpCenter: 'Welcome to the help center',
  howCanWeHelp: 'How can we help',
  searchForhelpArticle: 'Search for help articles',
  search: 'Search',
  popularSearches: 'Popular Searches',
  howToPlay: 'How to Play?',
  canIUploadMyGame: 'Can I upload my game?',
  howCanIReceivePayment: 'How can I receive payment?',
  popularTopics: 'Popular Topics',
  gettingStarted: 'Getting Started',
  gettingStartedDescriptions: 'Learn how to set up your account and start playing your first game.',
  paymentAndBilling: 'Payment & Billing',
  paymentAndBillingDescriptions: 'Manage your payment methods and get help with billing issues.',
  publishYourGame: 'Publish Your Game',
  publishYourGameDescriptions: 'Steps to upload and distribute your game on our platform.',
  accountSecurity: 'Account Security',
  accountSecurityDescriptions: 'Keep your account safe with our security guidelines and tips.',
  accountSettings: 'Account Settings',
  accountSettingsDescriptions: 'Update your profile, password, and email preferences.',
  gameplayIssues: 'Gameplay Issues',
  gameplayIssuesDescriptions: 'Troubleshoot in-game problems like lag, crashes, or bugs.',
  marketplaceAndItems: 'Marketplace & Items',
  marketplaceAndItemsDescriptions: 'Buy, sell, or trade items with other players securely.',
  communityGuidelines: 'Community Guidelines',
  communityGuidelinesDescriptions: 'Understand what is and isn’t allowed in the community.',
}
