<template>
  <table class="table w-full border-spacing-y-2 border-separate">
    <caption class="caption-bottom text-white/50 font-light text-sm">
    ...
    <tbody>
      <tr v-for="ticket in ticketList" :key="ticket.id" class="w-full h-[3rem]">
        <td class="w-3/12 border-b-1">{{ ticket.content }}</td>
        ...
        <td class="w-2/12 border-b-1">{{ ticket.description }}</td>
