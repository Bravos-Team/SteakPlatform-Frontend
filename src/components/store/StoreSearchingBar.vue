<template>
  <div class="sticky z-10 -top-[2px] h-full w-full">
    <div
      class="flex flex-col px-8 laptop:px-3 laptop:flex-row bg-[#101014] py-3 gap-y-2 items-center justify-between min-w-full h-full">
      ...
      <div
        class="flex-wrap gap-y-2 w-full mobile:py-3 text-[#fff]/70 tablet:h-[100px] flex flex-row tablet:w-full tablet:items-center justify-between laptop:justify-end tablet:gap-5 laptop:items-center items-center">
