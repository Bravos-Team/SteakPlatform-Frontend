<template>
  <sidebar id="publisher-main-sidebar" variant="sidebar" side="left" collapsible="icon" class="bg-transparent/20">
    <spark :colorChanges="'#64403b'" class="!left-10 hidden tablet:block" :bottom="'-200'" :colorFirst="'#422277'"
...
import { userData, navItemsData } from '@/components/admin/sidebar/SidebarItem'
