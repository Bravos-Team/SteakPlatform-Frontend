  ...
  <div class="!overflow-auto">
    ...
    >
      ...
      >
        ...
        <div
          class="flex flex-wrap gap-x-6 items-center justify-center-safe tablet:justify-start gap-y-15 tablet:grid tablet:grid-cols-2 laptop:grid-cols-3 desktop:grid-cols-4"
        >
