  ...
  <div id="containerBoxes">
    ...
    <div class="pt-6 flex flex-col gap-y-6">
      ...
      <div v-if="gameComingSoonData?.data && !isGameComingSoonFetching" class="px-3">
        <CollaboratorsBar
          :is-loading-games="isGameComingSoonFetching"
          :title-compo="'Games Coming Soon'"
      ...
      <div v-if="gameNewestReleasesData?.data && !isGameNewestReleasesFetching" class="px-3">
        <CollaboratorsBar
          :title-compo="'Games Newest Releases'"
          :is-loading-games="isGameNewestReleasesFetching"
      ...
      <div v-if="topPlayedGamesData?.data && !isTopPlayedGamesFetching" class="px-3">
        <CollaboratorsBar
          :is-loading-games="isTopPlayedGamesFetching"
          :title-compo="'Games Top Played'"
