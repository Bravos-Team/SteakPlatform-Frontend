  ...
  <div class="text-black dark:text-white flex flex-col items-center justify-center px-4 min-h-screen">
    ...
    <form class="w-full max-w-md mx-auto space-y-4">
      <div>
        ...
        <input type="email" v-model="form.username" autocomplete="username"
    ...
    <footer class="mt-10 mb-10 flex flex-col items-center space-y-3">
      <a href="/auth/register" class="text-[#0af] italic underline">Tạo tài khoản</a>
...
import { genderDeviceId } from '@/utils/fingerprint'
