    ...
    <div class="flex text-black dark:text-white flex-col justify-center items-center px-4">
      ...
      <div class="font-light text-[16px] text-center text-gray-800 dark:text-white italic mb-3">
        ...
        <span class="block">
          ...
          hoặc
          <router-link to="/auth/register" class="underline text-blue-400">đổi email</router-link>
        </span>
        <span class="block">
          Đã có tài khoản?
          <router-link to="/auth/login" class="underline text-blue-400 ms-1">Đăng nhập</router-link>
        </span>
      </div>
    </div>
  </div>
